...
$_['payment_status_not_defined'] = 'Payment status is invalid.';

// Labels
$_['enabled_label'] = 'Enable/Disable';
$_['test_mode'] = 'Use the test environment';
$_['pending_status'] = 'Payment pending status';
